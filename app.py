...
with tab_login:
    ...
    if st.session_state.fyers is not None:
        ...
        client_id = st.text_input("Fyers App ID (e.g. XC1234567-100)")
        secret_key = st.text_input("Fyers Secret ID", type="password")
        ...
        redirect_url = st.text_input("Step 2: Paste the full redirected URL here")
